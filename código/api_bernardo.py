...
def register_user():
    ...
    try:
        ...
        # lock the users table to ensure that no errors
        # regarding the user id calculation occur
        # in simultaneous product creation attempts
...
def add_product():
    ...
    try:
        # lock the products table to ensure that no errors
        # regarding the product id calculation occur
        # in simultaneous product creation attempts
...
def buy_products():
    ...
    try:
        ...
        # ensure that no deadlock occurs while 2 buyers simultaneously
        # try to retrieve products in different orders
        cur.execute('lock table products')
...
def post_question(product_id=None, parents_question_id=None):
    ...
    try:
        # lock the questions table to ensure that no errors
        # regarding the question id calculation occur
        # in simultaneous question creation attempts
...
def add_campaign():
    ...
    try:
        ...
        # lock the campaign table to ensure that no errors
        # regarding the campaign id calculation occur
        # in simultaneous campaign creation attempts
...
def subscribe_campaign(campaign_id):
    ...
    try:
        ...
        # lock the coupon table to ensure that no errors
        # regarding the coupon id calculation occur
        # in simultaneous user subscriptions
